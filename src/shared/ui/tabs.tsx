...
>(({ className, variant = 'default', ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "flex w-full h-11 items-center justify-start gap-2 px-2 text-muted-foreground",
...
>(({ className, variant = 'default', ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            "hover:text-foreground data-[state=active]:border-primary data-[state=active]:text-accent-foreground data-[state=active]:font-semibold",
