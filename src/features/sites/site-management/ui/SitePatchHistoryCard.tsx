/**
 * Site Patch History Card Component
 * 사이트 패치 이력 카드 컴포넌트
 */
...
interface SitePatchHistoryCardProps {
  site: Site
}
...
export function SitePatchHistoryCard({ site }: SitePatchHistoryCardProps) {
  ...
  const { data: patchesResponse, isLoading } = usePatchHistories(
    ...
    {
      enabled: !!site.project?.projectId && !!site.siteId,
    }
  )
