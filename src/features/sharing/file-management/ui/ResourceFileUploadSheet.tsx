...
import type { ResourceTreeUploadFormData } from '../model/types'

interface ResourceFileUploadSheetProps {
  isOpen: boolean
...
export function ResourceFileUploadSheet({
  isOpen,
  formData,
  categoryName,
  isUploading,
  ...
  return (
    <FormSheet
      ...
      title="파일 업로드"
      description={`${categoryName}에 파일을 업로드합니다.`}
      submitLabel="업로드"
      submitIcon={Upload}
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          파일이 저장될 경로입니다. 예: /scripts/backup
        </p>
      </div>
