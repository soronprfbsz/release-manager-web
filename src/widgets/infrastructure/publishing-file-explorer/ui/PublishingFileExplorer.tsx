...
interface FileNodeProps {
  node: PublishingFileNode
  level: number
  onFileClick: (node: PublishingFileNode) => void
}
    ...
    return (
      <div>
        ...
        {isExpanded && sortedChildren.length > 0 && (
          <div>
            {sortedChildren.map((child: PublishingFileNode, index: number) => (
              <FileNode
      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent className="w-[800px] sm:max-w-[800px] flex flex-col gap-4">
          <SheetHeader>
            ...
            <SheetDescription>퍼블리싱 파일 구조를 확인합니다.</SheetDescription>
          </SheetHeader>
